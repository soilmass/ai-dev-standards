...
4. **Self-reviewed** — the author (human or agent) ran `05-verification/code-review-standard.md` against the full diff; misses are fixed or justified in the PR description.
