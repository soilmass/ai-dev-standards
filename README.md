...
| [`scripts/`](scripts/) | [new-project.sh](scripts/new-project.sh) (bootstrap) · [audit-completeness.sh](scripts/audit-completeness.sh) (footer audit) · [suite-ci.sh](scripts/suite-ci.sh) (library QA: footers + links + configs + bootstrap smoke test) |
