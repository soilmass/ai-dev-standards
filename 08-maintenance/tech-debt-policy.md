...
1. The project keeps a debt log — `docs/debt-log.md` (starter injected at bootstrap from `08-maintenance/debt-log.template.md`), one table:
...
## Bootstrap
- What new-project.sh injects for this standard: `docs/debt-log.md` (from `08-maintenance/debt-log.template.md`) — rows accrue from the first shortcut; this doc defines the policy around it.
