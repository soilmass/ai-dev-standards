...
| **03 Design** | — | — | — | — |
| Architecture standards | [architecture-standards.md](../03-design/architecture-standards.md) | architecture-map template | import-boundary lint ([biome.json](../stacks/nextjs-default/lint-config/biome.json)) | via lint config |
| Data modeling | [data-modeling.md](../03-design/data-modeling.md) | n/a | CI migrations guard ([pr.yml](../stacks/nextjs-default/ci/pr.yml)) | via PR workflow |
...
| Threat modeling | [threat-model.template.md](../03-design/threat-model.template.md) | same file | none-possible → fallback in [checklist §E](../05-verification/code-review-standard.md) | injected to `docs/` |
| **04 Build** | — | — | — | — |
...
| Testing strategy | [testing-strategy.md](../04-build/testing-strategy.md) | n/a | coverage gate + nightly tiers ([pr.yml](../stacks/nextjs-default/ci/pr.yml), [nightly.yml](../stacks/nextjs-default/ci/nightly.yml)) | via workflows |
...
| Release process | [release-process.md](../06-delivery/release-process.md) | n/a | commit-msg hook substrate ([commitlint.config.mjs](../stacks/nextjs-default/hooks/commitlint.config.mjs)) | via hooks |
...
| **07 Operations** | — | — | — | — |
| Observability | [observability.md](../07-operations/observability.md) | n/a | none-possible → fallback in [checklist §E](../05-verification/code-review-standard.md); console ban lint-backed | reference only |
...
| SLOs & error budgets | [slo-error-budgets.md](../07-operations/slo-error-budgets.md) | n/a — `docs/slos.md` shape defined in-doc | none-possible → fallback in [checklist §E](../05-verification/code-review-standard.md) | reference only |
...
| Tech debt | [tech-debt-policy.md](../08-maintenance/tech-debt-policy.md) | debt-log table defined in-doc | none-possible → fallback in [checklist §E](../05-verification/code-review-standard.md) | reference only |
...
| **Spines** | — | — | — | — |
| Security & privacy | [security-privacy.md](../_spines/security-privacy.md) | threat-model template | per-layer gates (see the spine's table) | via injected hooks/workflows/schema |
...
2. **Branch protection** (required checks, no force-push) is a host-side setting `new-project.sh` cannot set; called out in `ci-pipeline.md`'s bootstrap footer as the one manual step.
