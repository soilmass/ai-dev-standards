...
8. The `<title>` length sits in the band **30–60 characters** (CAL-C15). Below the floor it under-describes the page; above the ceiling it is truncated in search results and browser tabs, so the disambiguating tail is lost.
