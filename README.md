...
| [`_spines/`](_spines/) | [security-privacy](_spines/security-privacy.md) · [version-control](_spines/version-control.md) · [performance](_spines/performance.md) · [reliability](_spines/reliability.md) · [accessibility](_spines/accessibility.md) · [cost](_spines/cost.md) · [documentation](_spines/documentation.md) — cross-cutting concerns, referencing where they bite in each layer |
