...
3. Drops in the working templates (ADR, glossary, architecture map, spec, threat model, incident runbook, `docs/slos.md`, `docs/debt-log.md`, `docs/launch-readiness.md`) under `docs/`, the GitHub community-health set (`.github/CODEOWNERS`, `SECURITY.md`, `CONTRIBUTING.md`, `ISSUE_TEMPLATE/`), two host-side helper scripts — `scripts/setup-branch-protection.sh` (branch + tag protection + required signatures) and `scripts/configure-signing.sh` (commit/tag signing) — and `scripts/check-enforcement.sh`, the CI-run guard that fails a PR if a safety gate (strict typing, a safety lint, the coverage gate) was weakened to go green.

It is idempotent (re-running refuses to clobber files you've edited) and prints everything it did. This library is the only meta-tooling required; the printed next-steps (install dependencies, the gitleaks binary, wire git hooks, run `configure-signing.sh` and `setup-branch-protection.sh`) then finish project setup.
...
| [`01-context/`](01-context/) | [CLAUDE.template](01-context/CLAUDE.template.md) · [adr.template](01-context/adr.template.md) · [glossary.template](01-context/glossary.template.md) · [architecture-map.template](01-context/architecture-map.template.md) · [CONTRIBUTING.template](01-context/CONTRIBUTING.template.md) · [SECURITY.template](01-context/SECURITY.template.md) · [setup-branch-protection / configure-signing](01-context/) (helper scripts + issue templates) |
...
| [`03-design/`](03-design/) | [architecture-standards](03-design/architecture-standards.md) · [data-modeling](03-design/data-modeling.md) · [api-contract-design](03-design/api-contract-design.md) · [api-evolution](03-design/api-evolution.md) · [rate-limiting-abuse](03-design/rate-limiting-abuse.md) · [ui-design-system](03-design/ui-design-system.md) · [design-tokens-and-hig](03-design/design-tokens-and-hig.md) · [ui-accessibility-patterns](03-design/ui-accessibility-patterns.md) · [multi-page-site-coherence](03-design/multi-page-site-coherence.md) · [per-page-quality-baseline](03-design/per-page-quality-baseline.md) · [responsive-layout-discipline](03-design/responsive-layout-discipline.md) · [graphics-asset-cohesion](03-design/graphics-asset-cohesion.md) · [web-security-headers](03-design/web-security-headers.md) · [threat-model.template](03-design/threat-model.template.md) · [threat-modeling](03-design/threat-modeling.md) · [data-privacy](03-design/data-privacy.md) |
| [`04-build/`](04-build/) | [coding-standards](04-build/coding-standards.md) · [git-standards](04-build/git-standards.md) · [testing-strategy](04-build/testing-strategy.md) · [dependency-policy](04-build/dependency-policy.md) · [supply-chain](04-build/supply-chain.md) · [static-analysis](04-build/static-analysis.md) · [third-party-integrations](04-build/third-party-integrations.md) · [secrets-config](04-build/secrets-config.md) · [developer-experience](04-build/developer-experience.md) · [refactoring-discipline](04-build/refactoring-discipline.md) |
| [`05-verification/`](05-verification/) | [definition-of-done](05-verification/definition-of-done.md) · [code-review-standard](05-verification/code-review-standard.md) · [ci-pipeline](05-verification/ci-pipeline.md) · [a11y-perf-gates](05-verification/a11y-perf-gates.md) · [load-testing](05-verification/load-testing.md) · [visual-regression](05-verification/visual-regression.md) |
| [`06-delivery/`](06-delivery/) | [deployment-strategy](06-delivery/deployment-strategy.md) · [release-process](06-delivery/release-process.md) · [migration-discipline](06-delivery/migration-discipline.md) · [rollback](06-delivery/rollback.md) · [launch-readiness](06-delivery/launch-readiness.md) · [launch-readiness.template](06-delivery/launch-readiness.template.md) · [infrastructure-as-code](06-delivery/infrastructure-as-code.md) · [secrets-promotion](06-delivery/secrets-promotion.md) |
| [`07-operations/`](07-operations/) | [observability](07-operations/observability.md) · [product-analytics](07-operations/product-analytics.md) · [incident-runbook.template](07-operations/incident-runbook.template.md) · [oncall-escalation](07-operations/oncall-escalation.md) · [slo-error-budgets](07-operations/slo-error-budgets.md) · [slos.template](07-operations/slos.template.md) · [error-budget-policy](07-operations/error-budget-policy.md) · [backup-dr](07-operations/backup-dr.md) · [audit-log-retention](07-operations/audit-log-retention.md) · [incident-postmortem](07-operations/incident-postmortem.md) |
| [`08-maintenance/`](08-maintenance/) | [dependency-updates](08-maintenance/dependency-updates.md) · [tech-debt-policy](08-maintenance/tech-debt-policy.md) · [deprecation-process](08-maintenance/deprecation-process.md) · [maintenance-cadence](08-maintenance/maintenance-cadence.md) · [debt-log.template](08-maintenance/debt-log.template.md) |
| [`_spines/`](_spines/) | [security-privacy](_spines/security-privacy.md) · [version-control](_spines/version-control.md) · [performance](_spines/performance.md) · [reliability](_spines/reliability.md) · [accessibility](_spines/accessibility.md) · [design-system-coherence](_spines/design-system-coherence.md) · [functional-verification](_spines/functional-verification.md) · [cost](_spines/cost.md) · [compliance](_spines/compliance.md) · [documentation](_spines/documentation.md) — cross-cutting concerns, referencing where they bite in each layer |
